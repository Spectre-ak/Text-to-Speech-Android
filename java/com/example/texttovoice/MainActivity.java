...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		US = (Button) findViewById(R.id.button3);
		French = (Button) findViewById(R.id.button5);
		HIN = (Button) findViewById(R.id.button6);
		UK = (Button) findViewById(R.id.button7);
		set = (Button) findViewById(R.id.button8);
